               ...
               <div class='topbar'>
                    ...
                    <?php
						...
						if (isset($_COOKIE['email'])) {
							...
							echo "<span id='login-register' title='Залогиниться или зарегистрироваться!)' onclick=\"link_click(event);\" class='link' href=\"javascript: document.location.href = 'login-register.php';\">Войти</span>";
						}
					?>
					<!-- end ul.toplinks -->
               </div>
                  ...
                  <div>
                     <div>
                        <div>
						   ...
						   <div>
									<img class='picture' src='images/img1.png' />
										<div  style='font-size: 22pt;'>
										   <p><br></p>
										   <p><span style='border: 5px double red; width: 50%; word-wrap: break-word;'>&#160Отражение&#160</span></p>
										</div>
								...
								<div>
									<img class='picture' src='images/img7.png' />
										<div  style='font-size: 22pt;'>
										   <p><br></p>
										   <p><span style='border: 5px double red; width: 50%; word-wrap: break-word;'>&#160Восточный Элефант&#160</span></p>
										</div>
									   <div class='collection'>
											<br><br>
										   <span class='content'>КОЛЛЕКЦИЯ</span><br><br>
								...
								<div>
									<img class='picture' src='images/img3.png' />
										<div  style='font-size: 22pt;'>
										   <p><br></p>
										   <p><span style='border: 5px double red; width: 50%; word-wrap: break-word;'>&#160Осенний пейзаж&#160</span></p>
										</div>
									   <div class='collection'>
											<br><br>
										   <span class='content'>КОЛЛЕКЦИЯ</span><br><br>
                        ...
                        <nav>
							...
							<?php
								if ($_COOKIE['email'] == "admin@gmail.com") {
									echo "<p><a href='adminka/adminka_.php'>Администрирование сайтом</a></p>";
								}
							?>
                        </nav>
                        <!-- .footer-menu -->
